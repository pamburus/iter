...
//
// It takes a predicate that returns true or false and applies it to each element of the iterator, and if any of them return true, then Find returns the element and true.
